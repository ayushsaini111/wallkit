      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-500 to-slate-900 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Please read these terms carefully before using WallKit. By using our platform, you agree to be bound by these terms and conditions.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mb-16 bg-white border-l-4 border-blue-500 pl-8">
          <p className="text-lg text-slate-700 leading-relaxed">
            These Terms & Conditions constitute a legally binding agreement between you and <strong>Wallkit</strong> regarding your access to and use of the Wallkit website, applications, and related services. By accessing or using the Platform, you acknowledge that you have read, understood, and agree to be bound by these Terms. These terms govern all aspects of your relationship with Wallkit, including but not limited to user conduct, intellectual property rights, privacy considerations, and dispute resolution procedures. We strongly encourage you to review these terms periodically as they may be updated to reflect changes in our services or applicable laws.
          </p>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-slate-50 p-8 rounded-xl">
            <p className="text-lg text-slate-700 leading-relaxed">
              Wallkit grants you a limited, non-exclusive, non-transferable, and revocable license to access and use the Platform strictly for personal and non-commercial purposes. You agree not to copy, distribute, modify, reverse engineer, or create derivative works of any content obtained from the Platform, unless expressly permitted by Wallkit or the respective rights holder. Wallpapers and media available on Wallkit may be protected by copyright or other intellectual property rights, and you agree to respect such rights at all times. This license does not grant you any ownership rights in the Platform or its content, and all rights not expressly granted remain reserved by Wallkit. Commercial use of our content requires separate written permission and may be subject to licensing fees. Any unauthorized commercial use will result in immediate license termination and potential legal action.
            </p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-slate-50 p-8 rounded-xl">
            <p className="text-lg text-slate-700 leading-relaxed">
              All trademarks, logos, designs, software, and proprietary content that form part of the Wallkit Platform are the exclusive property of Wallkit or its licensors and are protected by copyright, trademark, and other intellectual property laws. Any unauthorized use, reproduction, modification, or distribution of this intellectual property is strictly prohibited and may result in civil and criminal penalties. Creators who upload wallpapers retain ownership of their original work but grant Wallkit a worldwide, royalty-free, non-exclusive license to display, distribute, and promote such content within the scope of the Platform and related marketing materials. This license includes the right to create thumbnails, previews, and derivative works necessary for platform functionality. Users acknowledge that any feedback, suggestions, or ideas provided to Wallkit may be used without compensation or attribution.
            </p>
          </div>
        </section>
